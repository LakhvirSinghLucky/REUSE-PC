...
<body>
    ...
    //     $insert_query = "INSERT INTO my_order VALUES ('','$Product_id','$seller_id','$custom_id')";
    //     $insert_result = mysqli_query($conn, $insert_query);
    ...
    //     }
    //     } else {
    //         echo "Error 01: " . mysqli_error($conn);
    //     }
    //     //     if (mysqli_num_rows($result) > 0) {
    //     //         echo "<h2>Product IDs related to Seller ID: $seller_id</h2>";
    //     //         echo "<ul>";
    //     //         echo "<li>$product_id</li>";
    //     //         echo "</ul>";
    //     //     } else {
    //     //         // No products found for the given seller ID
    //     //         echo "No products found for Seller ID: $seller_id";
    //     //     }
    // } else {
